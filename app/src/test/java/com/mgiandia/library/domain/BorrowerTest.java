...
public class BorrowerTest {
    ...
    public void memberFunctions() {
        ...
        borrower.setBorrowerNo(1);
        Assert.assertEquals(1, borrower.getBorrowerNo());

        Person person = new Person("First", "Last");


        borrower.setFirstName(person.getFirstName());
        Assert.assertEquals("First", borrower.getFirstName());

        borrower.setLastName(person.getLastName());
        Assert.assertEquals("Last", borrower.getLastName());

        borrower.setEmail(new EmailAddress("mail@mail.com"));
        Assert.assertEquals(new EmailAddress("mail@mail.com"), borrower.getEmail());

        borrower.setTelephone(new TelephoneNumber("123"));
        Assert.assertEquals(new TelephoneNumber("123"), borrower.getTelephone());
