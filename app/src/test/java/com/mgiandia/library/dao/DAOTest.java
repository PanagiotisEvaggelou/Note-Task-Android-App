...
public class DAOTest {
    ...
    public void setUp() {
        ...
        bookDao = new NoteDAOMemory();
        publisherDao = new PublisherDAOMemory();
        authorDao = new ContactDAOMemory();
    ...
    public void saveItem() {
        Note book = new Note(bookDao.nextId(), "Don Quixote 2", new ISBN("1234567"), "978-3-16-20", 2016, publisherDao.find(2));
