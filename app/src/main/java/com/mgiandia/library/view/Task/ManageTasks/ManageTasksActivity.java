...
import com.mgiandia.library.view.Task.AddEditTask.AddEditTaskActivity;
import com.mgiandia.library.view.Task.TaskDetails.TaskDetailsActivity;
import com.mgiandia.library.view.Util.AdvancedListAdapter;



public class ManageTasksActivity extends AppCompatActivity implements ManageTasksView, SearchView.OnQueryTextListener
{
    ManageTasksPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        presenter = new ManageTasksPresenter(this, new TaskDAOMemory(), new ContactDAOMemory());
