...
public class AdvancedListAdapter extends BaseAdapter implements Filterable
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (AppConfig.getInstance().isWorkingWithTasks() == "c"){
            View rowView = inflater.inflate(R.layout.adapter_item_contact, parent, false);
            ...
            return rowView;
        } else if (AppConfig.getInstance().isWorkingWithTasks() == "n") {
            ...
            return rowView;
        } else if (AppConfig.getInstance().isWorkingWithTasks() == "t") {
            View rowView = inflater.inflate(R.layout.adapter_item_task, parent, false);
