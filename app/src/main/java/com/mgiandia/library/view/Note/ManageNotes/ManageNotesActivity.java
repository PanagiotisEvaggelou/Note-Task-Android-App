...
import com.mgiandia.library.view.Note.NoteDetails.NoteDetailsActivity;
...
public class ManageNotesActivity extends AppCompatActivity implements ManageNotesView, SearchView.OnQueryTextListener
{
    ManageNotesPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        presenter = new ManageNotesPresenter(this, new NoteDAOMemory(), new ContactDAOMemory());
