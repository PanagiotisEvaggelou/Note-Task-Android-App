...
public class Note {
     ...
     */
    public Note(int uid, String title, String content, ISBN isbn, String publication,
                int publicationYear) {
        this.uid = uid;
        this.title = title;
    ...
    /**
     * Προσθήκη ενός συγγραφέα ({@link Contact}) στους συγγραφείς του βιβλίου.
    ...
    /**
     * Απομάκρυνση ενός συγγραφέα ({@link Contact})
     * από τους συγγραφείς του βιβλίου.
     * @param author Ο συγγραφέας
     */
    public void removeAuthor(Contact author) {
        if (author != null) {
